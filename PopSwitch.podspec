...
Pod::Spec.new do |s|
  ...
  s.description  = "A switch that has a fun spring animation added."

  s.homepage     = "https://github.com/wvabrinskas/PopSwitch.git"
  ...
  s.source       = { :git => "https://github.com/wvabrinskas/PopSwitch.git" , :tag => "#{s.version}" }
  ...
  s.source_files  = "PopSwitch/*.{swift}"
